...
public class PmcXmlCustomMetaGroup {

    @XmlElement(name = "custom-meta", required = true)
    protected List<PmcXmlCustomMeta> customMetas;
     ...
     * {@link PmcXmlCustomMeta }
     * 
     * 
     */
    public List<PmcXmlCustomMeta> getCustomMetas() {
        if (customMetas == null) {
            customMetas = new ArrayList<PmcXmlCustomMeta>();
        }
