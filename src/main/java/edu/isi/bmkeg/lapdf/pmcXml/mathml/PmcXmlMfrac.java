...
public class PmcXmlMfrac {
    ...
    protected PmcXmlCentering denomalign;
    @XmlAttribute(name = "numalign")
    protected PmcXmlCentering numalign;
     ...
     * @return
     *     possible object is
     *     {@link PmcXmlCentering }
     *     
     */
    public PmcXmlCentering getDenomalign() {
        if (denomalign == null) {
            return PmcXmlCentering.CENTER;
        } else {
            return denomalign;
        }
    }
     ...
     *     
     */
    public void setDenomalign(PmcXmlCentering value) {
     ...
     *     
     */
    public PmcXmlCentering getNumalign() {
        if (numalign == null) {
            return PmcXmlCentering.CENTER;
        } else {
            return numalign;
     ...
     *     
     */
    public void setNumalign(PmcXmlCentering value) {
        this.numalign = value;
    }
