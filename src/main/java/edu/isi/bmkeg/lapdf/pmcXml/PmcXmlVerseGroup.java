...
public class PmcXmlVerseGroup {

    protected PmcXmlLabel label;
    protected PmcXmlTitle title;
    protected PmcXmlSubtitle subtitle;
    @XmlElements({
        @XmlElement(name = "verse-line", type = PmcXmlVerseLine.class),
     ...
     *     
     */
    public PmcXmlSubtitle getSubtitle() {
        return subtitle;
    }
     ...
     *     
     */
    public void setSubtitle(PmcXmlSubtitle value) {
        this.subtitle = value;
    }
