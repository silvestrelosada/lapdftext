...
public class PmcXmlTable {

    @XmlElement(name = "colgroup")
    protected List<PmcXmlColgroup> colgroups;
    @XmlElement(name = "col")
    protected List<PmcXmlCol> cols;
    @XmlElement(name = "tr")
    protected List<PmcXmlTr> trs;
    protected PmcXmlThead thead;
    protected PmcXmlTfoot tfoot;
    @XmlElement(name = "tbody")
    protected List<PmcXmlTbody> tbodies;
     ...
     * 
     */
    public List<PmcXmlColgroup> getColgroups() {
        if (colgroups == null) {
            colgroups = new ArrayList<PmcXmlColgroup>();
        }
     ...
     * 
     */
    public List<PmcXmlCol> getCols() {
        if (cols == null) {
            cols = new ArrayList<PmcXmlCol>();
        }
        return this.cols;
    }
     ...
     *     
     */
    public void setThead(PmcXmlThead value) {
        this.thead = value;
    }
     ...
     *     
     */
    public void setTfoot(PmcXmlTfoot value) {
        this.tfoot = value;
    }
     ...
     * 
     */
    public List<PmcXmlTbody> getTbodies() {
        if (tbodies == null) {
            tbodies = new ArrayList<PmcXmlTbody>();
        }
        return this.tbodies;
    }
