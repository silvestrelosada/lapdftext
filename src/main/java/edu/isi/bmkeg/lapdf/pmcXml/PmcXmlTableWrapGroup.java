...
public class PmcXmlTableWrapGroup {
    ...
    protected List<PmcXmlTableWrap> tableWraps;
     ...
     * 
     */
    public List<PmcXmlTableWrap> getTableWraps() {
        if (tableWraps == null) {
            tableWraps = new ArrayList<PmcXmlTableWrap>();
        }
