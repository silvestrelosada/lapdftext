...
public class PmcXmlStringConf {

    @XmlElementRefs({
        @XmlElementRef(name = "conf-num", type = PmcXmlConfNum.class, required = false),
        @XmlElementRef(name = "conf-acronym", type = PmcXmlConfAcronym.class, required = false),
        ...
        @XmlElementRef(name = "string-conf", type = PmcXmlStringConf.class, required = false),
        ...
        @XmlElementRef(name = "conf-theme", type = PmcXmlConfTheme.class, required = false),
