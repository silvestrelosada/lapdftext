...
@XmlType(name = "", propOrder = {
    "boldsAndItalicsAndMonospaces"
})
@XmlRootElement(name = "element-citation")
public class PmcXmlElementCitation {
    ...
    protected List<Object> boldsAndItalicsAndMonospaces;
    ...
    /**
     * Gets the value of the boldsAndItalicsAndMonospaces property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the boldsAndItalicsAndMonospaces property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBoldsAndItalicsAndMonospaces().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getBoldsAndItalicsAndMonospaces() {
        if (boldsAndItalicsAndMonospaces == null) {
            boldsAndItalicsAndMonospaces = new ArrayList<Object>();
        }
